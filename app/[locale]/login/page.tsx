  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-3xl font-bold text-green-800 mb-8 text-center">{t('login_title')}</h1>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          {t('no_account')}{' '}
          <Link href={`/${locale}/signup`} className="text-green-700 font-medium hover:underline">
            {t('signup_title')}
          </Link>
        </p>
      </div>
